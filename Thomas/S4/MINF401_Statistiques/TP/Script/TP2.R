...
hist(GILETJAUNE$Sepal.Length,freq=FALSE,col=rainbow(20),breaks=n,main="Histogramme longueur S�pales")
hist(GILETJAUNE$Sepal.Width,freq=FALSE,col="yellow",breaks=m,main="Histogramme largeur S�pales")
hist(GILETJAUNE$Petal.Width,freq=FALSE,col="yellow",breaks=q,main="Histogramme largeur p�tales")
hist(GILETJAUNE$Petal.Length,freq=FALSE,col=rainbow(20),breaks=p,main="Histogramme longueur p�tales")
